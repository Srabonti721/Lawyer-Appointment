...
useCountUp({ref:countup, enableScrollSpy:500 , end:970, duration:5});
const count = useRef();
useCountUp({ref:count, end:570, duration:5, enableScrollSpy:500});
const counting = useRef();
useCountUp({ref:counting, end:1170, duration:5, enableScrollSpy:500});
const counted = useRef();
useCountUp({ref:counted, end:170, duration:5, enableScrollSpy:500});
    return (
